  ...
  return (
    <section className={styles.content}>
      <div className={styles.textContent}>
        ...
        <p>
          Nascemos no coração do Instituto de Informática da UFRGS. Somos movidos pela lógica,
          desafiados pela inovação e unidos pela paixão em construir o futuro digital.
        </p>
      </div>
